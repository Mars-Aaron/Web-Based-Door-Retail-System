 ...
 * @author Aaron@Mars
 */
public class ToggleActivityServlet extends SessionController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            accountFacade.toggleActivity(request.getParameter("id"), AccountStatus.values()[Integer.parseInt(request.getParameter("accountStatus"))]);
            response.sendRedirect(request.getContextPath() + "/ManagerDashboard/ReadUsers");
    ...
    protected List<ServicePermission> getRequiredPermissions() {
        return Arrays.asList(new ServicePermission[]{ServicePermission.UPDATE_ACCOUNT, ServicePermission.READ_ACCOUNT});
    }
}
