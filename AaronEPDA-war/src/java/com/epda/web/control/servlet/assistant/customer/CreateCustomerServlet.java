 ...
 * @author Aaron@Mars
 */
public class CreateCustomerServlet extends SessionController {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("content", "createCustomer");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            validatePermission(request, response);
            customerFacade.create(request.getParameter("name"), request.getParameter("address"), request.getParameter("phone"));
