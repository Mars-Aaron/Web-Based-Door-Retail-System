 ...
 */
package com.epda.web.control.servlet.installer;
 ...
 * @author Aaron@Mars
 */
public class DashboardServlet extends SessionController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("InstallerDashboard/ReadJobs").forward(request, response);
    ...
    protected List<ServicePermission> getRequiredPermissions() {
        return Arrays.asList(new ServicePermission[]{ServicePermission.READ_PROFILE, ServicePermission.READ_ACCOUNT});
    }

    @Override
    protected List<AccountRole> getPermittedAccountRole() {
        return Arrays.asList(new AccountRole[]{AccountRole.TechnicalInstaller});
    }
