 ...
 * @author Aaron@Mars
 */
public class GenerateReceiptServlet extends SessionController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("order", orderFacade.find(request.getParameter("id")));
            request.getRequestDispatcher("../assistant/content/receipt.jsp").forward(request, response);
    ...
    protected List<ServicePermission> getRequiredPermissions() {
        return Arrays.asList(new ServicePermission[]{ServicePermission.READ_ORDER, ServicePermission.READ_CUSTOMER});
    }
}
