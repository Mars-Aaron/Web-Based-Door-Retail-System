 ...
 */
package com.epda.web.control.servlet.installer.order;
 ...
 * @author Aaron@Mars
 */
public class ReadJobsServlet extends SessionController {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Object orders;
            if ((orders = profileFacade.getOrders(getAccountToken(request))) == null) {
                response.sendError(503);
            } else {
                request.setAttribute("contextPath", request.getContextPath());
                request.setAttribute("jobs", orders);
                request.setAttribute("content", "viewJobs");
                request.getRequestDispatcher("../installer/dashboard.jsp").forward(request, response);
            }
