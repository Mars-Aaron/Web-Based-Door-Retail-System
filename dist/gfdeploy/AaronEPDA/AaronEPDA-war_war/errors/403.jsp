                        ...
                        <div class="col-lg-7 mx-auto text-white">
                            <div class="row align-items-center d-flex flex-row">
                                ...
                                <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                                    ...
                                    <h3 class="font-weight-light">You are not allowed to access the resources at this URL.</h3>
                                </div>
                            </div>
                            <div class="row mt-5">
                                <div class="col-12 text-center mt-xl-2">
                                    <a class="text-white font-weight-medium" href="/AaronEPDA/Login">Back to home</a>
                                </div>
                            </div>
                        </div>
                    </div>
